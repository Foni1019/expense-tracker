...
expenses = ["Food", "Travel", "Entertainment", "Clothing", "Necessities", "School", "Saving"]
currency = "HUF"
#-----------------------
...
with st.form("entry_form", clear_on_submit=True):
    ...
    if submitted:
        db.insert_transaction(category, str(dateOfTransaction), amount, comment, typeOfTransaction)
        st.write("Data Saved!")
